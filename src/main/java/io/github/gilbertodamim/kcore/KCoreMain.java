package io.github.gilbertodamim.kcore;
...
public class KCoreMain extends JavaPlugin {
    final public static String pluginName = "§bK§cCore";
    final public static String pluginTagName = "§f[" + pluginName + "§f]";
    public static Double version = 1.0;

    public static KCoreMain instance;
    ...
    public static void disableLoggers() throws NoSuchFieldException, IllegalAccessException {
        try {
    ...
    public void onEnable() {
        ...
        try {
            ...
            if (LibChecker.libChecker) {
                KCoreMain.instance().getServer().getConsoleSender().sendMessage(pluginTagName + " " + restartBukkit);
