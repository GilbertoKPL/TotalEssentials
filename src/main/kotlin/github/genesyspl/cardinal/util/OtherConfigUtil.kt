...
import github.genesyspl.cardinal.loops.Announcements
    ...
    fun start() {
        ...
        try {
            ...
            if (dif) {
                ...
                if (github.genesyspl.cardinal.configs.MainConfig.getInstance().announcementsEnabled) {
                    TaskUtil.getInstance().restartAnnounceExecutor()
                    Announcements.getInstance().start(
                        announce.size,
                        github.genesyspl.cardinal.configs.MainConfig.getInstance().announcementsTime
                    )
                }
            }
        } catch (e: Exception) {
